...
const HomePage = (props) => {
  return (
      <Jumbotron  className='text-center home'>
        <h1 className="display-3" style={{'fontSize':'3.7rem'}}>Hello, I'm <span className='text-danger'>Rohan Sharma</span></h1>
        <p className="display-4 text-info" style={{'fontSize':'2.7rem'}}>A Full Stack Web Developer</p>
        <p className="display-4" style={{'fontSize':'2.7rem'}}>Based in New Delhi, India</p>
        <p className="lead">

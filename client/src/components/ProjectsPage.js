      ...
      <Row>
        ...
        <div className="card text-white bg-dark mb-4">
          ...
          <div className="card-body">
            ...
            <p className="card-text">A mailer made using Nodejs, cron and nodemailer.</p>
            <div className='sub'> 
            <div className='subleft'>
            <p className='text-muted'>nodejs &nbsp; cron &nbsp; nodemailer</p>
            </div>
            <div className='subright'>
            <a href='https://github.com/RhnSharma/mailer' target='_blank' rel='noopener noreferrer'><FaGithub className='link' color='white' title='Github repository link'/></a>
            </div>
            </div>
          </div>
        </div>
        <div className="card text-white bg-dark mb-4">
          ...
          <div className="card-body">
            ...
            <div className='subright'>
            <a href='https://young-temple-48299.herokuapp.com/' target='_blank' rel='noopener noreferrer'><FaExternalLinkSquareAlt className='link' color='white' title='Chat app link'/></a>
            <a href='https://github.com/RhnSharma/node-chat-app' target='_blank' rel='noopener noreferrer'><FaGithub className='link' color='white' title='Github repository link'/></a>
            </div>
            </div>
          </div>
        </div>
        <div className="card text-white bg-dark">
          ...
          <div className="card-body">
            ...
            <div className='subright'>
            <a href='https://codepen.io/rhnsharma5113/full/yovXVv' target='_blank' rel='noopener noreferrer'><FaExternalLinkSquareAlt className='link' color='white' title='Calculator app link'/></a>
            </div>
            </div>
          </div>
        </div>
